...
function coord(mesh::SphericalBasisCurvilinearGrid3D, (i, j, k)::NTuple{3,Int})
  @SVector [
    mesh.node_coordinates.r[i, j, k],
    mesh.node_coordinates.θ[i, j, k],
    mesh.node_coordinates.ϕ[i, j, k],
  ]
end
